...
import helpingh from '../../Media/helpingh.png';
        ...
        < div >
            ...
            <div className="helping_hands">
                ...
                <div data-aos="zoom-out-down" className="helping_hands_main">
                    ...
                    <img src={helpingh} alt="mission_img" className="helping_hands_img" />
                </div>
            </div>
            ...
            {/* footer Start */}
            <div style={{ textAlign: "center", backgroundColor: "#000D6B", color: "white" }}>
                <p style={{color: "#fff"}}>Save Lives, Share Foods</p>
            </div>
            {/* footer end */}
            <Snackbar
                anchorOrigin={{
