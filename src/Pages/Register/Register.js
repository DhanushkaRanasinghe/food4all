                    ...
                    <div className="overlay-container">
                        <div className="overlay">
                            <div className="overlay-panel overlay-left">
                                <h1 style={{color:"#FF5DA2"}}>Welcome Back!</h1>
                                <p style={{color:"#FF5DA2"}}>To keep connected with us please login with your personal info</p>
                                <button onClick={openSignInPanel} className="ghost">Sign In</button>
                            </div>
                            <div className="overlay-panel overlay-right">
                                <h1 style={{color:"#FF5DA2"}}>Hello, Friend!</h1>
                                <p style={{color:"#FF5DA2"}}>Enter your personal details and start journey with us</p>
